...
async function forceEnv(): Promise<void> {
  // Remove quotes and line endings from values
  const envContent = `NEXT_PUBLIC_SUPABASE_URL=https://qkxifbkphhdywoscmmyh.supabase.co
